...
import com.realityandapp.paopao_official_deliveryman.BuildConfig;
import com.realityandapp.paopao_official_deliveryman.R;
import com.realityandapp.paopao_official_deliveryman.models.http.im.VideoEntity;
import com.realityandapp.paopao_official_deliveryman.utils.im.video.util.ImageCache;
import com.realityandapp.paopao_official_deliveryman.utils.im.video.util.ImageResizer;
import com.realityandapp.paopao_official_deliveryman.utils.im.video.util.Utils;
import com.realityandapp.paopao_official_deliveryman.widget.im.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(R.drawable.im_empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(R.layout.im_image_grid_fragment,
				container, false);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView= LayoutInflater.from(mContext).inflate(R.layout.im_choose_griditem, container,false);
			...
			if(position==0)
			{
				...
				holder.imageView.setImageResource(R.drawable.im_actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(R.drawable.im_empty_photo);
