...
import com.realityandapp.paopao_official_deliveryman.views.adapter.im.ChatAllHistoryAdapter;
...
public class ChatAllHistoryFragment extends PaopaoBaseFragment {
    ...
    // todo un comment groups
//    private List<EMGroup> groups;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.im_fragment_conversation_history, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // contact list
        contactList = PaopaoOfficialDeliverymanApplication.getInstance().getContactList();
...
//        groups = EMGroupManager.getInstance().getAllGroups();
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (username.equals(PaopaoOfficialDeliverymanApplication.getInstance().getUserName()))
...
//						intent.putExtra("chatType", ChatActivity.CHATTYPE_GROUP);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        getActivity().getMenuInflater().inflate(R.menu.im_delete_message, menu);
        // }
    }
...
//            ((MainActivity) getActivity()).updateUnreadLabel();
     ...
     */
    public void refresh() {
        adapter = new ChatAllHistoryAdapter(getActivity(), R.layout.im_row_chat_history, loadConversationsWithRecentChat());
        listView.setAdapter(adapter);
        adapter.notifyDataSetChanged();
    }
