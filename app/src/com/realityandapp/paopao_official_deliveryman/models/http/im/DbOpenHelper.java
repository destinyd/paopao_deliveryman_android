 ...
 */
package com.realityandapp.paopao_official_deliveryman.models.http.im;
...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String USERNAME_TABLE_CREATE = "CREATE TABLE "
            + IMUserDao.TABLE_NAME + " ("
            + IMUserDao.COLUMN_NAME_NICK + " TEXT, "
            + IMUserDao.COLUMN_NAME_ID + " TEXT PRIMARY KEY);";
    ...
    private static String getUserDatabaseName() {
        return PaopaoOfficialDeliverymanApplication.getInstance().getUserName() + "_demo.db";
    }
